...
def segment_pec_fins(dataRoot):
    ...
    def create_figure(df, gene_name=None, plot_type=None, toggle_bool=None):
        ...
        if (plot_type == None) | (plot_type == "3D Scatter"):
            ...
            fig = px.scatter_3d(df.iloc[np.where(high_flags)], x=xs, y=ys, z=zs, opacity=0.5, color=plot_gene,
    ...
    def chart_3d(gene_name, fileName, plot_type, toggle_switch):
        ...
        f = create_figure(df, gene_name, plot_type, toggle_bool)
